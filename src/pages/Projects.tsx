                ...
                <div className="max-w-[1320px] mx-auto px-6">
                    <SectionReveal>
                        <div className="text-center mb-16">
                            ...
                            <p
                                className="text-[#9CA3AF] max-w-lg mx-auto"
                                style={{
                            ...
                            >
                                A curated collection of work spanning product
                                design, web development, and creative
                                engineering.
                            </p>
                        </div>
                    </SectionReveal>
                                    ...
                                    <div className="relative bg-[#14141A] h-full rounded-2xl border border-white/[0.08] overflow-hidden hover:border-[#4DA3FF]/30 transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_0_40px_rgba(77,163,255,0.08)]">
                                        <div className="relative aspect-[16/10] overflow-hidden">
                                            ...
                                            <div className="absolute inset-0 bg-gradient-to-t from-[#0B0B0F]/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center">
                                                <span
                                                    className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/10 backdrop-blur-sm text-white border border-white/[0.12]"
                                                    style={{
                                                        fontFamily:
                                                            "'Inter', sans-serif",
                                                        fontSize: "0.875rem",
