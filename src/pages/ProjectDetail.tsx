        ...
        return (
            <div className="min-h-screen bg-[#0B0B0F] flex items-center justify-center text-white pt-[72px]">
                <div className="text-center">
                    ...
                    <Link
                        to="/projects"
                        className="text-[#4DA3FF] mt-4 inline-block"
                    >
                        Back to Projects
                    </Link>
                </div>
            ...
            <section className="py-16 md:py-24">
                <div className="max-w-[1320px] mx-auto px-6">
                    ...
                    >
                        ...
                        <p
                            className="text-[#9CA3AF] max-w-2xl mb-8"
                            style={{
                                fontFamily: "'Inter', sans-serif",
                                fontSize: "1.0625rem",
                                lineHeight: 1.7,
                        ...
                        <div className="flex flex-wrap gap-2 mb-12">
                            {project.tags.map((tag) => (
                                <span
                                    key={tag}
                                    className="px-4 py-1.5 rounded-lg bg-white/[0.05] text-[#9CA3AF] border border-white/[0.06]"
                                    style={{
                                        fontFamily: "'Inter', sans-serif",
                                        fontSize: "0.8125rem",
                                    }}
